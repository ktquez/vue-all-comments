...
(function () {
  if (typeof document !== 'undefined') {
    var head = document.head || document.getElementsByTagName('head')[0],
        style = document.createElement('style'),
        css = " /* General */ ul[data-v-07e0b4e6] { list-style-type: none; } .fullX[data-v-07e0b4e6] { width: 100%; float: left; } .fl[data-v-07e0b4e6] { float: left; } /* style */ .vac[data-v-07e0b4e6] { margin-top: 20px; } .vac-tab-social[data-v-07e0b4e6] { margin-bottom: 20px; border-bottom: 3px solid transparent; } .vac-tab-social .item-icon[data-v-07e0b4e6] { cursor: pointer; float: left; position: relative; padding: 12px 0 12px 15px; height: 100%; } .vac-tab-social .item-icon.-active[data-v-07e0b4e6]:before { display: block; } .vac-tab-social .vac-icon[data-v-07e0b4e6] { width: 22px; float: left; opacity: 0.6; margin-right: 8px; transition: opacity .5s } .vac-tab-social .item-icon:hover .vac-icon[data-v-07e0b4e6], .vac-tab-social .item-icon.-active .vac-icon[data-v-07e0b4e6] { opacity: 1; } .vac-tab-social .item-icon[data-v-07e0b4e6]:before { content: ''; border: 10px solid transparent; border-top-color: inherit; position: absolute; left: 55%; bottom: -20px; transform: translateX(-50%); display: none; } .vac-icon .fill-disqus[data-v-07e0b4e6] { fill: #2e9fff; } .vac-tab-social .txt-icon[data-v-07e0b4e6] { font-family: inherit; font-size: 10px; font-weight: bold; float: left; margin-top: 4px; color: #888; letter-spacing: .7px; } .vac-tab-social .item-icon:not(:last-child) .txt-icon[data-v-07e0b4e6]:after { content: ''; width: 1px; height: 20px; float: right; background-color: #ddd; margin-left: 20px; margin-top: -3px; } ";style.type = 'text/css';if (style.styleSheet) {
      style.styleSheet.cssText = css;
    } else {
      style.appendChild(document.createTextNode(css));
    }head.appendChild(style);
...
(function () {
  if (typeof document !== 'undefined') {
    var head = document.head || document.getElementsByTagName('head')[0],
        style = document.createElement('style'),
        css = " * { margin: 0; padding: 0; } body { font-family: Tahoma, Geneva, sans-serif } p { margin: 30px 0; color: #666; font-size: 14px; letter-spacing: 1.2px; line-height: 18px; } .content { max-width: 960px; padding: 10px; margin: 0 auto; } .txt_comments { margin-top: 30px; } ";style.type = 'text/css';if (style.styleSheet) {
      style.styleSheet.cssText = css;
    } else {
      style.appendChild(document.createTextNode(css));
    }head.appendChild(style);
...
var App = { render: function render() {
  ...
  components: {
    VueAllComments: VueAllComments$1
  }
};
